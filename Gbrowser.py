...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        home_btn.setStatusTip("Ir para home")
        ...
        file_menu = self.menuBar().addMenu("&Aba")
        new_tab_action = QAction(QIcon(os.path.join('icons', 'cil-library-add.png')), "Nova Aba", self)
        new_tab_action.setStatusTip("Nova Aba")
        ...
        navigate_home_action = QAction(QIcon(os.path.join('icons', 'cil-exit-to-app.png')),
                                            "Home", self)
        navigate_home_action.setStatusTip("vá para a Spinn Design da Homepage")
...
app.setOrganizationDomain("Gaiote.org")
